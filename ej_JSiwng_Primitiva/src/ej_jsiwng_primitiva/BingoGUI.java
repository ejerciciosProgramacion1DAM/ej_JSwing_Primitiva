...
public class BingoGUI extends JDialog {
        ...
        for (int fila = 0; fila < 3; fila++) {
            for (int col = 0; col < 9; col++) {
                if (carton[fila][col] == 0) {
                    ...
                    ImageIcon icono = new ImageIcon(getClass().getResource("/ej_jsiwng_primitiva/logo.png"));
    ...
    private void mostrarVentanaGanador() {
        ...
        ImageIcon gif = new ImageIcon(getClass().getResource("/ej_jsiwng_primitiva/bingo.gif"));
